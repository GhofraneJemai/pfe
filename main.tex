...
% Pour les sous-sections (1.1, 1.2...) - LES INDENTER PAR RAPPORT AUX SECTIONS
...
% Pour les sous-sous-sections (1.1.1...) - ENCORE PLUS INDENTÉES
...
% Format de numérotation automatique : a), b), c), ...
...
% === PAGE 1 : TON PDF ===
\includepdf[pages=1]{Remerciements.pdf}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{vs.jpg}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Visual Studio Code}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{intellij.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo IntelliJ IDEA}
\vspace{0.5\baselineskip}

\item \textbf{PyCharm} : IDE dédié au développement du service IA de détection des anomalies avec FastAPI. Ses fonctionnalités spécifiques à Python (débogueur, environnement virtuel) sont indispensables pour le service IA.

\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{pycharm.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo PyCharm}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.12\textwidth]{git.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Git}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{github.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo GitHub}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{draw.io.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo draw.io}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.09\textwidth]{figma2.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Figma}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.15\textwidth]{angular.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Angular}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{ts.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo TypeScript}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{html.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo HTML}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{scss.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo SCSS}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{bootstrap.jpg}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Bootstrap}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.12\textwidth]{sb.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Spring Boot}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{java.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Java}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{python.jpg}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Python}
\vspace{0.5\baselineskip}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{fapi.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo FastAPI}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.12\textwidth]{pgsql.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo PostgreSQL}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.15\textwidth]{keycloak.jpg}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Keycloak}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.25\textwidth]{docker1.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Docker}
\vspace{0.5\baselineskip}
\end{itemize}
...
\noindent
\hspace*{5cm}\includegraphics[width=0.1\textwidth]{postman.png}
\par\noindent
\hspace*{3.5cm}{\small\textbf{Figure:} Logo Postman}
\vspace{0.5\baselineskip}
\end{itemize}
...
\begin{itemize}
 ...
 \item \textbf{pdfplumber} : bibliothèque Python pour extraire le texte natif des PDF textuels. Très rapide et précis, elle est privilégiée pour les accords de mission au format PDF texte.
\end{itemize}
...
Un embedding est une représentation vectorielle d'un texte (mot, phrase ou document) dans un espace continu de dimensions fixes. Dans cet espace, deux textes sémantiquement proches auront des vecteurs proches, tandis que des textes de sens différent auront des vecteurs éloignés. Cette propriété permet de mesurer la similarité sémantique entre deux documents par le calcul de la distance (cosinus, euclidienne, etc.) entre leurs embeddings. Dans notre projet, les embeddings sont utilisés pour la détection des doublons.
...
Ce chapitre a présenté les concepts fondamentaux et les technologies spécifiquement utilisées dans le développement de Coral.io Expense. Les notions d'IA, de Machine Learning et de Deep Learning ont été définies. Ces bases théoriques permettent d'aborder sereinement les chapitres de réalisation.
...
\multirow{5}{*}{Rembourse-\\ments} & US-49 & 4 & \begin{itemize}
...
\includegraphics[width=1\textwidth,keepaspectratio,height=0.80\textheight]{authentification.png}
...
Le tableau suivant compare les performances des trois modèles testés. FAISS + SentenceTransformer obtient le meilleur compromis avec un F1-score de 0,97 et un temps de réponse de 120 ms.
...
Le tableau suivant compare les performances des trois LLM testés pour l'extraction automatique des champs. Gemma3:4b surpasse les deux autres avec un F1-score de 0,94 et un temps de réponse de 450 ms.
...
La figure suivante confirme visuellement la supériorité de Gemma3:4b sur l'ensemble des critères (précision, rappel, F1-score, vitesse).
