...
\titleformat{name=\subsubsection, numberless}
  ...
  [\vspace{0.3\baselineskip}]
% ============================================================
% CRÉATION D'UN NOUVEAU NIVEAU a.1, a.2, a.3...
% QUI S'ALIGNE CORRECTEMENT SOUS \subsubsection
% ============================================================

\newcounter{subsubsubcounter}[subsubsection]
\renewcommand{\thesubsubsubcounter}{\arabic{subsubsubcounter}}
...
\newcommand{\subsubsubsection}[1]{%
  ...
  \noindent
  \hspace*{8em}\textbf{\alph{subsubsection}.\thesubsubsubcounter) #1}%
  \par
...
\subsubsection{Définition des critères :}
...
\subsection{Diagramme des cas d'utilisation global du sprint 2}
...
\subsubsubsection{Autres anomalies (synthèse)}
