...
% CECI EST CE QUI MANQUE : l'indentation de la sous-section
...
\titlespacing*{\subsubsection}
  ...
  {0pt}
% ============================================================
% INDENTATION UNIFORMISÉE POUR LES SOUS-SOUS-SECTIONS NON NUMÉROTÉES
% ============================================================

% Pour les subsubsection numerotes (1.1.1)
\titleformat{\subsubsection}
  {\normalfont\bfseries}
  {\thesubsubsection}
  {1em}
...
\titlespacing*{\subsubsection}
  {5em}      % MÊME indentation que les numerotes
  {0.5\baselineskip}
  {0pt}
...
% ============================================================
% ============================================================
% PAGE DE REMERCIEMENTS (CORRIGÉE & COMPLÈTE)
% ============================================================
...
Nous tenons tout d'abord à exprimer notre profonde gratitude envers Allah, qui nous a accordé la santé, la patience et la force nécessaires pour mener à bien ce projet.

\vspace{0.3cm}

Nous adressons nos plus sincères remerciements à Madame \textbf{Safa Majdoub}, notre encadrante académique, pour son accompagnement précieux, la qualité de ses conseils et sa disponibilité. Son engagement à nos côtés a été une source de motivation tout au long de ce travail.

\vspace{0.3cm}

Nous remercions chaleureusement Madame \textbf{Oumaima Aounallah}, notre encadrante professionnelle, pour son accueil, sa confiance et le temps qu'elle nous a consacré. Ses remarques pertinentes ont largement facilité notre progression.

\vspace{0.3cm}

Nous tenons également à remercier l'ensemble des professeurs de l'ISET Nabeul, et plus particulièrement ceux du département des Sciences de l'Informatique, pour la qualité de leur enseignement et pour nous avoir transmis les compétences nécessaires à la réalisation de ce projet.

\vspace{0.3cm}

Enfin, nous exprimons notre reconnaissance aux membres du jury pour l'intérêt qu'ils portent à notre travail. Nous sommes honorés de pouvoir leur présenter le fruit de nos efforts.

\vspace{0.5cm}
\textbf{Merci à tous ceux qui ont cru en nous.}
